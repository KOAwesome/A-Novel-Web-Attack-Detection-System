"""a_novel_webattack_detection_systemURL Configuration
...
from a_novel_webattack_detection_system import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Web_Attack_Status_Type/$', remoteuser.Predict_Web_Attack_Status_Type, name="Predict_Web_Attack_Status_Type"),
    ...
    url(r'^View_Web_Attack_Status_Ratio/$', serviceprovider.View_Web_Attack_Status_Ratio, name="View_Web_Attack_Status_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Web_Attack_Status_Type/$', serviceprovider.View_Prediction_Of_Web_Attack_Status_Type, name="View_Prediction_Of_Web_Attack_Status_Type"),
