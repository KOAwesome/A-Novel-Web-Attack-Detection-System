...
ROOT_URLCONF = 'a_novel_webattack_detection_system.urls'
...
WSGI_APPLICATION = 'a_novel_webattack_detection_system.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'a_novel_webattack_detection_system',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
