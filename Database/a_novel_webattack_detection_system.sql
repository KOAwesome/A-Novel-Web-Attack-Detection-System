...
--
-- Host: localhost
-- Generation Time: Jan 09, 2022 at 11:27 AM
...
--
-- Database: `a_novel_webattack_detection_system`
--
CREATE DATABASE IF NOT EXISTS `a_novel_webattack_detection_system` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `a_novel_webattack_detection_system`;
...
(2, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karkataka', 'Bangalore');
...
(41, 'Naive Bayes', '48.91304347826087'),
(42, 'SVM', '53.2608695652174'),
(43, 'Logistic Regression', '52.17391304347826'),
(44, 'Decision Tree Classifier', '48.91304347826087'),
(45, 'SGD Classifier', '51.08695652173913'),
(46, 'Random Forest Classifier', '53.2608695652174');
...
(9, 'No Web Attacked', '50.0'),
(10, 'Web Attacked', '50.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_webattack_detection`
--

CREATE TABLE IF NOT EXISTS `remote_user_webattack_detection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `App_Names` varchar(300) NOT NULL,
  `Permissions` varchar(300) NOT NULL,
  `API_Name` varchar(300) NOT NULL,
  `Website_Name` varchar(30000) NOT NULL,
...
--
-- Dumping data for table `remote_user_webattack_detection`
--

INSERT INTO `remote_user_webattack_detection` (`id`, `App_Names`, `Permissions`, `API_Name`, `Website_Name`, `IP`, `Location`, `Prediction`) VALUES
(1, 'Attackers 2', 'INTERNET,READ_CONTACTS,ACCESS_FINE_LOCATION,ACCESS_COARSE_LOCATION,READ_PHONE_STATE,SEND_SMS', 'getSimSerialNumber', 'http://www.5riversmarketing.com/', '104.243.40.3', 'USA - Florida', 'No Web Attacked'),
(2, 'Logik Spielplatz fÂr Kinder', 'BLUETOOTH,BLUETOOTH_ADMIN,BROADCAST_STICKY,CHANGE_NETWORK_STATE,CHANGE_WIFI_MULTICAST_STATE,CHANGE_WIFI_STATE', 'cellLocation', 'http://www.kddi.com/', '106.128.86.173', 'Japan', 'No Web Attacked'),
(3, 'SQUIRREL', 'DISABLE_KEYGUARD,EXPAND_STATUS_BAR,GET_PACKAGE_SIZE,INSTALL_SHORTCUT,INTERNET,KILL_BACKGROUND_PROCESSES,MANAGE_OWN_CALLS,MODIFY_AUDIO_SETTINGS,NFC,READ_SYNC_SETTINGS,READ_SYNC_STATS', 'Not Sensitive', 'https://www.bloomberg.com/', '109.8.27.15', 'France', 'No Web Attacked'),
(4, 'Attackers 9', 'INTERNET,GET_ACCOUNTS,SEND_SMS,READ_PHONE_STATE', 'Not Sensitive', 'http://demo2.5riversmarketing.com/\r\n', '104.243.40.3', 'USA - Florida', 'Web Attacked'),
(5, 'Painting Puzzle', 'KILL_BACKGROUND_PROCESSES,MANAGE_OWN_CALLS,MODIFY_AUDIO_SETTINGS', 'getParams', 'https://www.att.com/', '74.240.68.75', 'United States', 'Web Attacked'),
(6, 'BUNTE FROGS', 'ACCESS_LOCATION_EXTRA_COMMANDS,ACCESS_NETWORK_STATE,ACCESS_NOTIFICATION_POLICY,ACCESS_WIFI_STATE', 'Not Sensitive', 'https://www.amazon.com/', '34.210.51.229', 'United States', 'No Web Attacked'),
(7, 'Real Steel', 'SET_WALLPAPER_HINTS,TRANSMIT_IR,USE_FINGERPRINT,VIBRATE', 'Not Sensitive', 'http://www.weathle.ca', '89.148.0.0', 'Brazil', 'No Web Attacked'),
(8, 'Fuhrer in LA', 'WRITE_SYNC_SETTINGS,READ_CALENDAR,WRITE_CALENDAR,READ_CONTACTS', 'sendTextMessage', 'http://www.warthmetl.org/', '93.95.24.0', 'Brunei Darussalam', 'Web Attacked'),
(9, 'Fuhrer in LA', 'WRITE_SYNC_SETTINGS,READ_CALENDAR,WRITE_CALENDAR,READ_CONTACTS', 'sendTextMessage', 'http://www.warthmetl.org/', '93.95.24.0', 'Brunei Darussalam', 'Web Attacked'),
(10, 'Fuhrer in LA', 'WRITE_SYNC_SETTINGS,READ_CALENDAR,WRITE_CALENDAR,READ_CONTACTS', 'sendTextMessage', 'http://www.warthmetl.org/', '93.95.24.0', 'Brunei Darussalam', 'Web Attacked'),
(11, 'AP Addition Game', 'ACCESS_LOCATION_EXTRA_COMMANDS,ACCESS_NETWORK_STATE,BLUETOOTH,BLUETOOTH_ADMIN', 'Not Sensitive', 'http://www.meisortaba.com/', '140.55.192.211', 'Cuba', 'No Web Attacked'),
(12, 'QuickHousing Van B.C. - Free', 'ACCESS_LOCATION_EXTRA_COMMANDS,ACCESS_NETWORK_STATE,ACCESS_NOTIFICATION_POLICY,ACCESS_WIFI_STATE', 'getSimSerialNumber', 'http://www.lelied.com/', '251.108.103.106', 'Ethiopia', 'Web Attacked');
